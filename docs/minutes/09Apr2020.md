...
Four datasets were proposed in total: [atomic spectral data](docs/proposals/spectra_visualization.md), [NASA's exoplanet archive](https://exoplanetarchive.ipac.caltech.edu/index.html), [COVID-19 data](docs/proposals/covid_19.md), and [atomic trajectories of hydrogen](docs/proposals/hsolid-vis.pdf). There was also a useful link to a [data-agnostic sonification method](http://www.aes.org/e-lib/browse.cfm?elib=19712).
